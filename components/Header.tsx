...
function Header() {
  ...
  return (
    <header
      className={[
        'fixed w-full overflow-x-scroll no-scrollbar backdrop-filter',
        'backdrop-blur-lg bg-white/50 dark:bg-white/5 z-20 trasition ease-in-out duration-500 print:hidden',
      ].join(' ')}
    >
